        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">Quản lý các sự kiện kiểm tra sức khỏe học sinh</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
          ...
          {loadingEvents ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600">Chưa có sự kiện kiểm tra sức khỏe nào được tạo</p>
            </div>
          ) : (
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tên sự kiện</th>
            ...
            <div className="p-6">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-gray-50 transition-all duration-200"
                  value={search}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    {search 
                      ...
                      : 'Chưa có học sinh nào tham gia sự kiện này'
                    }
                  </p>
                </div>
              ) : (
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredList.map((item, idx) => {
                        ...
                        const hasRecord = record && (record.vision || record.hearing || record.weight || record.height);
              ...
              <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="text-blue-900">{detail.student.studentId || 'Không có'}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-blue-700 font-medium">Họ tên:</span>
                        <span className="text-blue-900">{`${detail.student.lastName || ''} ${detail.student.firstName || ''}`.trim() || 'Không có'}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-blue-700 font-medium">Lớp:</span>
                        <span className="text-blue-900">{detail.student.classes?.name || 'Không có'}</span>
                      </div>
                    </div>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-blue-700 font-medium">Giới tính:</span>
                        <span className="text-blue-900">{detail.student.gender === "MALE" ? "Nam" : detail.student.gender === "FEMALE" ? "Nữ" : 'Không có'}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-blue-700 font-medium">Ngày sinh:</span>
                        <span className="text-blue-900">{detail.student.dateOfBirth || 'Không có'}</span>
                      </div>
                      <div className="flex justify-between">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-green-900">Thông tin phụ huynh</h3>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-green-700 font-medium">Họ tên:</span>
                      <span className="text-green-900">{detail.parent ? `${detail.parent.lastName || ''} ${detail.parent.firstName || ''}`.trim() : 'Không có'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-green-700 font-medium">Số điện thoại:</span>
                      <span className="text-green-900">{detail.parent?.phone || 'Không có'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-green-700 font-medium">Email:</span>
                      <span className="text-green-900">{detail.parent?.email || 'Không có'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Ghi nhận kết quả</h2>
                  </div>
                  <button
              ...
              <div className="p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-lg font-semibold text-blue-900">Thông tin học sinh</div>
                      <div className="text-sm text-gray-500">{`${recordTarget.item.student.lastName || ''} ${recordTarget.item.student.firstName || ''}`.trim() || 'Không có'}</div>
                      <div className="text-sm text-gray-500">{recordTarget.item.student.studentId || 'Không có'}</div>
                    </div>
                  </div>
                </div>
